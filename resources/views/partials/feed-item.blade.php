<li class="flex items-start gap-4 not-first:pt-2.5">
    <a class="shrink-0" href="/profile">
        <img alt="avatar" class="size-10 object-cover" src={{$item->profile->avatar}}>
    </a>
        ...
        <div class="border-b border-pixel-light/10 pb-5">
            ...
            <div class="flex justify-between items-center gap-4">
                <div class="flex items-center gap-2.5">
                    <p><a class="hover:underline" href="/profile">{{$item->profile->display}}</a></p>
            ...
            <div class="flex mt-8 gap-4 items-start border-t border-pixel-light/10 p-4 bg-pixel-light/[3%]">
                ...
                @include('partials.post-form',['labelText'=>'Reply Body','fieldName' => "reply","placeHolder" => "Reply to ". $item->profile->display ."'s post","rows" => "3"])
