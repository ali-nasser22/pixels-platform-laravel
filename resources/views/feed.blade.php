<x-layout title="Pixels - Feed">
    ...
    <main class="flex flex-col grow gap-4 overflow-y-auto no-scrollbar py-4 px-4 -mx-4">
        ...
        <div class="flex mt-8 gap-4 items-start border-b border-b-pixel-light/10 pb-4">
            ...
            <form class="grow">
                <label class="sr-only" for="post">Post Body</label><textarea
                    class="w-full text-lg px-1 resize-none mb-4"
                    id="post"
                    name="post"
                ...
                <div class="flex justify-between items-center gap-4">
                    ...
                    <button
                        class="bg-pixel text-pixel-dark px-4 py-1 border border-transparent text-sm hover:bg-pixel/90 transition-colors duration-150 active:bg-pixel/95 font-bold"
                        type="submit">Post
                    </button>
                </div>
            </form>
        ...
        <ol class="mt-4">
            ...
            <li class="flex items-start gap-4 not-first:pt-2.5">
                <a class="shrink-0" href="/profile">
                    <img alt="avatar" class="size-10 object-cover" src={{asset('images/michael.png')}}>
                </a>
                <div class="grow pt-1.5">
                    <div class="border-b border-pixel-light/10 pb-5">
                        <!--User Meta-->
                        <div class="flex justify-between items-center gap-4">
                            <div class="flex items-center gap-2.5">
                                <p><a class="hover:underline" href="/profile">Michael</a></p>
                                <p class="text-xs text-pixel-light/40">3h</p>
                                <p>
                                    <a class="text-xs text-pixel-light/40 hover:text-pixel-light/60 transition-opacity duration-100"
                                       href="/profile">@mmich_jj</a></p>
                            </div>
                        ...
                        <!--Post Content-->
                        <div
                            class="mt-4 text-sm flex flex-col gap-3 [&_a]:text-pixel [&_a]:hover:underline [&_a]:cursor-pointer">
                            <p>I made this! <a>#myartwork</a> <a>#pixel</a></p>
                            <img alt="pic-from-michael" src={{asset('images/simon-chilling.png')}}>
                        </div>
                        <!--Action buttons-->
                        ...
                        <!--Reply Form-->
                        <div class="flex mt-8 gap-4 items-start border-t border-pixel-light/10 p-4 bg-pixel-light/[3%]">
                            <a class="shrink-0" href="/profile">
                                <img alt="Avatar" class="size-10 object-cover" src={{asset('images/adrian.png')}}>
                            </a>
                            <form class="grow">
                                <label class="sr-only" for="reply">Reply Body</label><textarea
                                    class="w-full text-sm px-1 resize-none mb-4" id="reply"
                                    name="post"
                                    placeholder="Reply to Michale's Post"
                                    rows="5"></textarea>
                                <div class="flex justify-between items-center gap-4">
                                    <div class="flex gap-4 items-center">
                                        <button type="button">
                                    ...
                                    <button
                                        class="bg-pixel/10 text-pixel px-4 py-1 border border-transparent text-sm hover:bg-pixel/15 transition-colors duration-150 active:bg-pixel/20 font-bold"
                                        type="submit">Reply
                                    </button>
                                </div>
                            </form>
                    ...
                    <ol>
                        ...
                        <li class="relative pt-4 flex items-start gap-4 group/li">
                            ...
                            <a class="shrink-0 isolate" href="/profile">
                                <img alt="avatar" class="size-10 object-cover" src={{asset('images/mr-anderson.png')}}>
                            </a>
                            <div class="grow border-b border-pixel-light/10 pb-5 pt-1.5">
                                <div class="flex justify-between items-center gap-4">
                                    <div class="flex items-center gap-2.5">
                                        <p><a class="hover:underline" href="/profile">Mr.Anderson</a></p>
                                        <p class="text-xs text-pixel-light/40">2h</p>
                                        <p>
                                            <a class="text-xs text-pixel-light/40 hover:text-pixel-light/60 transition-opacity duration-100"
                                               href="/profile">@mr_anderson</a></p>
                                    </div>
                                    <button aria-label="Post options" class="flex gap-[3px] group py-2">
                                    <span
                                        class="size-1 bg-pixel-light/40 group-hover:bg-pixel-light/60 transition-opacity duration-100"></span>
                                ...
                                <div class="mt-4 text-sm flex flex-col gap-3">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad aut beatae
                                        blanditiis
                                        cupiditate
                                        deleniti enim esse facilis id illum iste laborum, laudantium, libero nihil, quae
                                        voluptate. Aut
                                        quidem sunt tempora.</p>
                                </div>
                                <!--Action buttons-->
                                <div class="flex justify-between items-center gap-4 mt-6">
                                    <div class="flex items-center gap-8">
